...
*/
func (a *RetentionApiService) CreateRetention(ctx context.Context, policy RetentionPolicy) (*http.Response, error) {
	var (
...
*/
func (a *RetentionApiService) GetRentenitionMetadata(ctx context.Context) (RetentionMetadata, *http.Response, error) {
	var (
...
*/
func (a *RetentionApiService) GetRetention(ctx context.Context, id int64) (RetentionPolicy, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return string
*/
func (a *RetentionApiService) GetRetentionTaskLog(ctx context.Context, id int64, eid int64, tid int64) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *RetentionApiService) OperateRetentionExecution(ctx context.Context, id int64, eid int64, body Body1) (*http.Response, error) {
	var (
...
*/
func (a *RetentionApiService) TriggerRetentionExecution(ctx context.Context, id int64, body Body) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *RetentionApiService) UpdateRetention(ctx context.Context, id int64, policy RetentionPolicy) (*http.Response, error) {
	var (
